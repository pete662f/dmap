...
class SelectedPlaceMarkerController(
    ...
    companion object {
        internal const val MARKER_IMAGE_ID = "selected-place-marker-image"
        internal const val MARKER_SOURCE_ID = "selected-place-marker-source"
        internal const val MARKER_LAYER_ID = "selected-place-marker-layer"
    }
}
